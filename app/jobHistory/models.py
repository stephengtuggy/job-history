...
class JobTimePeriod(models.Model):
    class Meta:
        ...
        constraints  = [
                        ...
                        models.UniqueConstraint(fields=['position', 'start_year', 'is_current_position'], name='job_time_period_must_be_unique_1'),
                        models.UniqueConstraint(fields=['position', 'start_year', 'end_year'], condition=models.Q(is_current_position__exact=False), name='job_time_period_start_and_end_year_must_be_unique_if_not_current_position'),
                       ]
